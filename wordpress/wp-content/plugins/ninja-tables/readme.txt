...
Best Table Plugin for WordPress with beautiful, fast and amazing responsive table features and fully drag and drop

== Description ==

[Details Features](https://wpmanageninja.com/ninja-tables/) | [Youtubude Video Tutorials](https://www.youtube.com/watch?v=-s0Gi39gOhE&t=0s&index=2&list=PLXpD0vT4thWGRfXfDvLdYbV7sI3LcaPCL)  | [Demo](https://wpmanageninja.com/ninja-tables/use-case/) | [User Guide](https://wpmanageninja.com/docs/ninja-tables)
...
### Awesome Support
Get dedicated support from our awesome happiness managers and developers and Yes! It's **completely free**. All you need to do is create a support ticket from here: https://wpmanageninja.com/support-tickets/ . Within a few hours (maximum), your problems will be solved. You can also request any features you want by creating the support tickets.

### Create Dynamic WooCommerce Product Tables [Pro Feature]
Now, you don't need to worry about<a href="https://wpmanageninja.com/create-woocommerce-product-tables/?utm_source=ninja-tables-wp-repo" target="_blank">how to create WooCommerce product tables</a> anymore. With Ninja Tables Pro integration, you can build dynamic WooCommerce product tables from your existing WooCommerce products with just a few clicks. Your users can buy bulk amount of products from a single page with built-in cart info and checkout buttons. The information of each WooCommerce product table can be presented in the best possible professional way. <a href="https://wpmanageninja.com/downloads/ninja-tables-pro-add-on/" target="_blank">Purchase Ninja Tables Pro</a> to unlock this feature.
[youtube https://www.youtube.com/watch?v=sh_q_kfuFrg]
...
>__Ninja table is still one of the most performant plugins I use.__
...
The full source code is availale on <a href="https://github.com/WPManageNinja/ninja-tables">github</a>. Feel free to report a bug report.
...
Yes, We have added this feature to version 2.2.5. Recently, many Ultimate Tables users wanted to move to Ninja Tables and this was one of the most wanted features. We have explored Ultimate Tables and added an optimized feature to transfer your "Ultimate Tables" data to Ninja Tables easily. Now You can transfer your "Ultimate Tables" data with a single click :)

= Can I import tables from "Data Tables Generator by Supsystic" Plugin to Ninja tables? =

Yes, We also added this feature to version 2.2.5. As like Ultimate Tables, some of our wanted to move their data from Data Tables Generator by Supsystic to Ninja Tables. We have added a feature where you can now transfer "Data Tables Generator by Supsystic" data to Ninja Tables with a single click.
...
= Can I connect google sheet in my WordPress Ninja Table? =
...
- WCAG AA Compitablity issue fixed
...
- Shortcode renering issue resolved
